...
!function(){function e(e,t,a,n,o,u,r,l,i,s,c){function d(e){switch(e){case"orange":e="#ca6531"}return e}function g(e){$(e.options).each(function(){this.checked=!1})}var m=this;m._content="//igor-vladyka.github.io/realplanet/data/",m.style={country_default:function(e){return m.moduleManager.country&&m.moduleManager.country.getId()==e.getId()?{weight:0,fillColor:d("orange"),color:d("orange"),opacity:1}:{weight:0,fillColor:"transparent",color:"transparent",opacity:0}}},m.initialize=function(t,d){m.moduleManager={modules:[]},m.boundsMap=t;var h=[],p=a.load(t,m._content,m.style.country_default,m.activateCountry);h.push(p);var y=c.load(t,m._content);return h.push(y),g(n),m.moduleManager.modules.push(n),m.moduleManager[n.name]=n,h.push(n.load(m._content)),d.homeCountry?(o.initUserSettings(d.schengenVisa,d.usaVisa,d.homeCountry),m.moduleManager.modules.push(o),m.moduleManager[o.name]=o,h.push(o.load(m._content))):$(n.options).each(function(){this.checked=!0}),g(u),m.moduleManager.modules.push(u),m.moduleManager[u.name]=u,h.push(u.load(m._content)),g(r),m.moduleManager.modules.push(r),m.moduleManager[r.name]=r,h.push(r.load(m._content)),g(l),m.moduleManager.modules.push(l),m.moduleManager[l.name]=l,h.push(l.load(m._content)),g(i),m.moduleManager.modules.push(i),m.moduleManager[i.name]=i,h.push(i.load(m._content)),g(s),m.moduleManager.modules.push(s),m.moduleManager[s.name]=s,h.push(s.load(m._content)),e.all(h)},m.initDefaults=function(e){setTimeout(function(){$("input:checked").parent("label:not(.active)").button("toggle"),i.initDefault(),s.initDefault(),e&&(i.monthPanel().show(),s.rainPanel().show())},100)},m.evaluateMap=function(){m.activeFilters=[],$(m.moduleManager.modules).each(function(){var e=this;if(e.options){var t={name:e.name,aliases:[],origin:e},a=$(e.options).filter(function(){return this.checked&&t.aliases.push(this.alias),this.checked});a.length&&m.activeFilters.push(t)}}),m.activeFilters.length?1==m.activeFilters.length?a.layer.setStyle(m.setupSinglefilter):a.layer.setStyle(m.setupMultifilter):a.layer.setStyle(m.style.country_default),$(m.moduleManager.modules).each(function(){var e=this;e.evaluateGlobal&&e.evaluateGlobal(m.activeFilters)})},m.setupSinglefilter=function(e){var t="gray",a=m.activeFilters[0],n=a.origin.setup(e);return $.inArray(n,a.aliases)!=-1&&(t=n),{weight:0,fillColor:d(t),color:d(t),opacity:1}},m.setupMultifilter=function(e){var t="gray",a=!0;return $(m.activeFilters).each(function(){var t=this,n=t.origin.setup(e);return a=$.inArray(n,t.aliases)!=-1}),a&&(t="green"),{weight:0,fillColor:d(t),color:d(t),opacity:.8}},m.monthChanged=function(){m.moduleManager.country?m.evaluateModules(m.moduleManager.country):m.evaluateMap()},m.deactivateCountry=function(){m.moduleManager.country=null,m.evaluateMap(),m.evaluateModules(),t.transitionTo("filter",null,{location:!0,notify:!1})},m.activateCountryByIso=function(e){var t=a.getCountryByIso(e),n=new L.LatLngBounds(new L.LatLng(t.c.properties.min[1],t.c.properties.min[0]),new L.LatLng(t.c.properties.max[1],t.c.properties.max[0]));m.activateCountry(t.c,t.l,n)},m.activateCountry=function(e,a,n){m.moduleManager.country&&m.moduleManager.country.getId()==e.getId()?(m.deactivateCountry(),m.boundsMap.setView(L.latLng(0,0),3)):(m.moduleManager.country=e,m.evaluateModules(e),a.setStyle(m.style.country_default),t.transitionTo("filter",{iso3:e.properties.ISO3},{location:!0,notify:!1}),m.boundsMap.fitBounds(n))},m.evaluateModules=function(e){$(m.moduleManager.modules).each(function(){var t=this;t.evaluateCountry&&t.evaluateCountry(e)})},m.canChangeFilters=function(){return null==m.moduleManager.country}}angular.module("real.planet").service("filterModules",["$q","$state","countriesService","budgetService","visaService","touristService","safetyService","internetService","temperatureService","rainService","worldHeritageService",e])}();
