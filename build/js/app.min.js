...
!function(){function e(e,t,a,n,o,u,r,i,l,s,c){function d(e){switch(e){case"orange":e="#ca6531"}return e}function g(e){$(e.options).each(function(){this.checked=!1})}var h=this;h._content="//igor-vladyka.github.io/realplanet/data/",h.style={country_default:function(e){return h.moduleManager.country&&h.moduleManager.country.getId()==e.getId()?{weight:0,fillColor:d("orange"),color:d("orange"),opacity:1}:{weight:0,fillColor:"transparent",color:"transparent",opacity:0}}},h.initialize=function(t,d){h.moduleManager={modules:[]},h.boundsMap=t;var m=[],p=c.load(t,h._content);m.push(p);var y=a.load(t,h._content,h.style.country_default,h.activateCountry);return m.push(y),g(n),h.moduleManager.modules.push(n),h.moduleManager[n.name]=n,m.push(n.load(h._content)),d.homeCountry?(o.initUserSettings(d.schengenVisa,d.usaVisa,d.homeCountry),h.moduleManager.modules.push(o),h.moduleManager[o.name]=o,m.push(o.load(h._content))):$(n.options).each(function(){this.checked=!0}),g(u),h.moduleManager.modules.push(u),h.moduleManager[u.name]=u,m.push(u.load(h._content)),g(r),h.moduleManager.modules.push(r),h.moduleManager[r.name]=r,m.push(r.load(h._content)),g(i),h.moduleManager.modules.push(i),h.moduleManager[i.name]=i,m.push(i.load(h._content)),g(l),h.moduleManager.modules.push(l),h.moduleManager[l.name]=l,m.push(l.load(h._content)),g(s),h.moduleManager.modules.push(s),h.moduleManager[s.name]=s,m.push(s.load(h._content)),e.all(m)},h.initDefaults=function(e){setTimeout(function(){$("input:checked").parent("label:not(.active)").button("toggle"),l.initDefault(),s.initDefault(),e&&(l.monthPanel().show(),s.rainPanel().show())},100)},h.evaluateMap=function(){h.activeFilters=[],$(h.moduleManager.modules).each(function(){var e=this;if(e.options){var t={name:e.name,aliases:[],origin:e},a=$(e.options).filter(function(){return this.checked&&t.aliases.push(this.alias),this.checked});a.length&&h.activeFilters.push(t)}}),h.activeFilters.length?1==h.activeFilters.length?a.layer.setStyle(h.setupSinglefilter):a.layer.setStyle(h.setupMultifilter):a.layer.setStyle(h.style.country_default),$(h.moduleManager.modules).each(function(){var e=this;e.evaluateGlobal&&e.evaluateGlobal(h.activeFilters)})},h.setupSinglefilter=function(e){var t="gray",a=h.activeFilters[0],n=a.origin.setup(e);return $.inArray(n,a.aliases)!=-1&&(t=n),{weight:0,fillColor:d(t),color:d(t),opacity:1}},h.setupMultifilter=function(e){var t="gray",a=!0;return $(h.activeFilters).each(function(){var t=this,n=t.origin.setup(e),o=JSON.parse(JSON.stringify(t.aliases));return o.push("gray"),a=$.inArray(n,o)!=-1}),a&&(t="green"),{weight:0,fillColor:d(t),color:d(t),opacity:.8}},h.monthChanged=function(){h.moduleManager.country?h.evaluateModules(h.moduleManager.country):h.evaluateMap()},h.deactivateCountry=function(){h.moduleManager.country=null,h.evaluateMap(),h.evaluateModules(),t.transitionTo("filter",null,{location:!0,notify:!1})},h.activateCountryByIso=function(e){var t=a.getCountryByIso(e),n=new L.LatLngBounds(new L.LatLng(t.c.properties.min[1],t.c.properties.min[0]),new L.LatLng(t.c.properties.max[1],t.c.properties.max[0]));h.activateCountry(t.c,t.l,n)},h.activateCountry=function(e,a,n){h.moduleManager.country&&h.moduleManager.country.getId()==e.getId()?(h.deactivateCountry(),h.boundsMap.setView(L.latLng(0,0),3)):(h.moduleManager.country=e,h.evaluateModules(e),a.setStyle(h.style.country_default),t.transitionTo("filter",{iso3:e.properties.ISO3},{location:!0,notify:!1}),h.boundsMap.fitBounds(n))},h.evaluateModules=function(e){$(h.moduleManager.modules).each(function(){var t=this;t.evaluateCountry&&t.evaluateCountry(e)})},h.canChangeFilters=function(){return null==h.moduleManager.country}}angular.module("real.planet").service("filterModules",["$q","$state","countriesService","budgetService","visaService","touristService","safetyService","internetService","temperatureService","rainService","worldHeritageService",e])}();
