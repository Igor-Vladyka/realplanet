window.notifyUpdateAvailable=function(){window.location.reload()},"serviceWorker"in navigator&&navigator.serviceWorker.register("sw.js").then(function(e){e.onupdatefound=function(){var n=e.installing;n.onstatechange=function(){switch(n.state){case"installed":navigator.serviceWorker.controller&&(console.info("New version available"),window.notifyUpdateAvailable());break;case"redundant":console.error("The installing service worker became redundant.")}}},$.get("images/markers/marker-icon-green.png"),$.get("images/markers/marker-icon-red.png"),$.get("images/markers/marker-icon-orange.png")}).catch(function(e){console.info("ServiceWorker registration failed: ",e)}),String.prototype.hash=function(){for(var e=this,n=Array(this.length),r=0;r<this.length;r++)n[r]=r;return Array.prototype.map.call(n,function(n){return e.charCodeAt(n).toString(16)}).join("")},toastr.options={closeButton:!1,debug:!1,newestOnTop:!1,progressBar:!1,positionClass:"toast-top-right",preventDuplicates:!0,onclick:null,showDuration:"300",hideDuration:"2000",timeOut:"3000",extendedTimeOut:"1000",showEasing:"swing",hideEasing:"linear",showMethod:"fadeIn",hideMethod:"fadeOut"},Array.prototype.removeAll=function(e){var n=this.indexOf(e);-1!==n&&(this.splice(n,1),this.removeAll(e))},L.Icon.Default.imagePath="images/markers/";
