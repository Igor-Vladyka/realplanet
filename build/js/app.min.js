...
!function(){function e(e,t){var n=angular.extend(this,t);n._schengen=n._usa=!1,n._file="visa/round.world.visa.{country}.json",n.name="visa",n.order=1,n.icon={i:!0,class:"icon-visa-main",text:"Visa"},n.options=[{alias:"blue",text:"Home country",checked:!0,icon:{i:!0,class:"icon-home",cellWidth:"25%"}},{alias:"green",text:"Don't required",checked:!0,icon:{i:!0,class:"icon-visa-green-filter",cellWidth:"25%"}},{alias:"yellow",text:"On arrival or other",checked:!0,icon:{i:!0,class:"icon-visa-yellow-filter",cellWidth:"25%"}},{alias:"red",text:"Required",checked:!0,icon:{i:!0,class:"icon-visa-red-filter",cellWidth:"25%"}}],n.initUserSettings=function(e,t,i){n._schengen=e,n._usa=t,n._country=i},n.load=function(e){var t=n._file.replace("{country}",n._country);return n.initialLoad(e+t).then(function(e){n.data=e})},n.setupCountry=function(e){return n.setup(e)},n.setup=function(e){var t=n.getDataItem(e,n.data),i="gray";return null!=t&&(n._schengen&&"green"===t.alias.schengen&&(i=t.alias.schengen),n._usa&&"green"===t.alias.usa&&(i=t.alias.usa),"green"!=i&&(i=t.alias.general)),i},n.addEvents=function(){$(document).on("change",'input:checkbox[value="schengen"],input:checkbox[value="usa"]',function(e){n._schengen=$('input:checkbox[value="schengen"]').is(":checked"),n._usa=$('input:checkbox[value="usa"]').is(":checked")})},n.evaluateCountry=function(e){if(n.activeCountry=n.getCountryOption(e,n.options,n.setup),e&&n.activeCountry.text){var t=n.getDataItem(e,n.data);t&&t.shortInfo&&(n.activeCountry.text=t.shortInfo)}},n.canShowTimaticLink=function(e){return n._country.toLowerCase()!==e.toLowerCase()},n.showTimatic=function(e){var t=n.data.filter(function(t){return t.target==e});if(n.timaticWindow&&(n.timaticWindow.close(),n.timaticWindow=null),1==t.length){var i=screen.width/2-150,a=screen.height/2-250;n.timaticWindow=window.open("","Detailed Visa Information","location=0,menubar=0,status=0,titlebar=0,toolbar=0,width=300px,height=535px,left="+i+"px,top="+a+"px"),n.timaticWindow.document.write(n.constructChildWindow(t[0]))}},n.constructChildWindow=function(e){return e.shortInfo+"<hr>"+e.longInfo+"<hr>"+e.vaccination}}angular.module("real.planet").service("visaService",["$q","baseFilterService",e])}();
