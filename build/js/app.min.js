...
!function(){function e(e,t,a,n,o,u,r,l,i,s){function c(e){switch(e){case"orange":e="#ca6531"}return e}function d(e){$(e.options).each(function(){this.checked=!1})}var g=this;g._content="//igor-vladyka.github.io/realplanet/data/",g.style={country_default:function(e){return g.moduleManager.country&&g.moduleManager.country.getId()==e.getId()?{weight:0,fillColor:c("orange"),color:c("orange"),opacity:1}:{weight:0,fillColor:"transparent",color:"transparent",opacity:0}}},g.initialize=function(t,c){g.moduleManager={modules:[]},g.boundsMap=t;var h=[],m=a.load(t,g._content,g.style.country_default,g.activateCountry);return h.push(m),d(n),g.moduleManager.modules.push(n),g.moduleManager[n.name]=n,h.push(n.load(g._content)),c.homeCountry?(o.initUserSettings(c.schengenVisa,c.usaVisa,c.homeCountry),g.moduleManager.modules.push(o),g.moduleManager[o.name]=o,h.push(o.load(g._content))):$(n.options).each(function(){this.checked=!0}),d(u),g.moduleManager.modules.push(u),g.moduleManager[u.name]=u,h.push(u.load(g._content)),d(r),g.moduleManager.modules.push(r),g.moduleManager[r.name]=r,h.push(r.load(g._content)),d(l),g.moduleManager.modules.push(l),g.moduleManager[l.name]=l,h.push(l.load(g._content)),d(i),g.moduleManager.modules.push(i),g.moduleManager[i.name]=i,h.push(i.load(g._content)),d(s),g.moduleManager.modules.push(s),g.moduleManager[s.name]=s,h.push(s.load(g._content)),e.all(h)},g.initDefaults=function(e){setTimeout(function(){$("input:checked").parent("label:not(.active)").button("toggle"),i.initDefault(),s.initDefault(),e&&(i.monthPanel().show(),s.rainPanel().show())},100)},g.evaluateMap=function(){g.activeFilters=[],$(g.moduleManager.modules).each(function(){var e=this;if(e.options){var t={name:e.name,aliases:[],origin:e},a=$(e.options).filter(function(){return this.checked&&t.aliases.push(this.alias),this.checked});a.length&&g.activeFilters.push(t)}}),g.activeFilters.length?1==g.activeFilters.length?a.layer.setStyle(g.setupSinglefilter):a.layer.setStyle(g.setupMultifilter):a.layer.setStyle(g.style.country_default),$(g.moduleManager.modules).each(function(){var e=this;e.evaluateGlobal&&e.evaluateGlobal(g.activeFilters)})},g.setupSinglefilter=function(e){var t="gray",a=g.activeFilters[0],n=a.origin.setup(e);return $.inArray(n,a.aliases)!=-1&&(t=n),{weight:0,fillColor:c(t),color:c(t),opacity:1}},g.setupMultifilter=function(e){var t="gray",a=!0;return $(g.activeFilters).each(function(){var t=this,n=t.origin.setup(e);return a=$.inArray(n,t.aliases)!=-1}),a&&(t="green"),{weight:0,fillColor:c(t),color:c(t),opacity:.8}},g.monthChanged=function(){g.moduleManager.country?g.evaluateModules(g.moduleManager.country):g.evaluateMap()},g.deactivateCountry=function(){g.moduleManager.country=null,g.evaluateMap(),g.evaluateModules(),t.transitionTo("filter",null,{location:!0,notify:!1})},g.activateCountryByIso=function(e){var t=a.getCountryByIso(e),n=new L.LatLngBounds(new L.LatLng(t.c.properties.min[1],t.c.properties.min[0]),new L.LatLng(t.c.properties.max[1],t.c.properties.max[0]));g.activateCountry(t.c,t.l,n)},g.activateCountry=function(e,a,n){g.moduleManager.country&&g.moduleManager.country.getId()==e.getId()?(g.deactivateCountry(),g.boundsMap.setView(L.latLng(0,0),3)):(g.moduleManager.country=e,g.evaluateModules(e),a.setStyle(g.style.country_default),t.transitionTo("filter",{iso3:e.properties.ISO3},{location:!0,notify:!1}),g.boundsMap.fitBounds(n))},g.evaluateModules=function(e){$(g.moduleManager.modules).each(function(){var t=this;t.evaluateCountry&&t.evaluateCountry(e)})},g.canChangeFilters=function(){return null==g.moduleManager.country}}angular.module("real.planet").service("filterModules",["$q","$state","countriesService","budgetService","visaService","touristService","safetyService","internetService","weatherService","rainService",e])}();
...
!function(){function e(e){var t=this;t.initialLoad=function(t){var n=e.defer();if("undefined"!==Storage&&localStorage[t]){var r=JSON.parse(localStorage[t]);n.resolve(r)}else $.getJSON(t,function(e){"undefined"!==Storage&&(localStorage[t]=JSON.stringify(e)),n.resolve(e)});return n.promise},t.getDataItem=function(e,t){var n=e.getId(),r=null,a=$.grep(t,function(e){return e.target===n});return a.length>0&&(r=a[0]),r},t.getCountryOption=function(e,t,n){var r=null;if(e){var a=n(e);r=$(t).filter(function(){return this.alias==a}),r=r&&r.length?r[0]:{text:" ",icon:{class:""},alias:a}}return r}}angular.module("real.planet").service("baseFilterService",["$q",e])}();
!function(){function e(e,t){var i=angular.extend(this,t);i._file="budget/real.planet.budget.json",i.name="budget",i.icon={i:!0,class:"icon-budget-main",text:"Budget"},i.order=2,i.options=[{alias:"blue",text:"Cheapest",checked:!1,icon:{i:!0,class:"icon-budget-green-filter",cellWidth:"25%"}},{alias:"green",text:"Really nice",checked:!1,icon:{i:!0,class:"icon-budget-yellow-filter",cellWidth:"25%"}},{alias:"yellow",text:"Can afford",checked:!1,icon:{i:!0,class:"icon-budget-orange-filter",cellWidth:"25%"}},{alias:"red",text:"Highest costs",checked:!1,icon:{i:!0,class:"icon-budget-red-filter",cellWidth:"25%"}}],i.load=function(e){return i.initialLoad(e+i._file).then(function(e){i.data=e})},i.setupCountry=function(e){return i.setup(e)},i.setup=function(e){var t=i.getDataItem(e,i.data);return t?t.alias:"gray"},i.evaluateCountry=function(e){i.activeCountry=i.getCountryOption(e,i.options,i.setup)}}angular.module("real.planet").service("budgetService",["$q","baseFilterService",e])}();
...
!function(){function e(e,t){var n=angular.extend(this,t);n.name="internet",n._file="internet/real.planet.internet.json",n.icon={i:!0,class:"icon-internet-main",text:"Internet"},n.order=5,n.options=[{alias:"blue",text:"Wifi everywhere",checked:!1,icon:{i:!0,class:"icon-internet-green-filter",cellWidth:"25%"}},{alias:"green",text:"Easy access",checked:!1,icon:{i:!0,class:"icon-internet-yellow-filter",cellWidth:"25%"}},{alias:"yellow",text:"Wifi can be found",checked:!1,icon:{i:!0,class:"icon-internet-orange-filter",cellWidth:"25%"}},{alias:"red",text:"OMG no internet...",checked:!1,icon:{i:!0,class:"icon-internet-red-filter",cellWidth:"25%"}}],n.load=function(e){return n.initialLoad(e+n._file).then(function(e){n.data=e})},n.setupCountry=function(e){return n.setup(e)},n.setup=function(e){var t=n.getDataItem(e,n.data);return t?t.alias:"gray"},n.evaluateCountry=function(e){n.activeCountry=n.getCountryOption(e,n.options,n.setup)}}angular.module("real.planet").service("internetService",["$q","baseFilterService",e])}();
!function(){function e(e,i){var t=angular.extend(this,i);t._selected=(new Date).getMonth()+1,t.name="rain",t._file="weather/real.planet.weather.json",t.icon={i:!0,class:"icon-weather-main",text:"Rains"},t.order=6,t.options=[{alias:"red",text:"No raint at all",checked:!1,icon:{i:!0,class:"icon-fire",cellWidth:"20%"}},{alias:"yellow",text:"True rare",checked:!1,icon:{i:!0,class:"icon-weather-green-filter",cellWidth:"20%"}},{alias:"green",text:"Sometimes",checked:!1,icon:{i:!0,class:"icon-weather-yellow-filter",cellWidth:"20%"}},{alias:"blue",text:"Happens",checked:!1,icon:{i:!0,class:"icon-weather-orange-filter",cellWidth:"20%"}},{alias:"white",text:"Alwais rainy",checked:!1,icon:{i:!0,class:"icon-weather-red-filter",cellWidth:"20%"}}],t.months=[{index:1,name:"Jan",class:"width-33 divider-border-vertical-right"},{index:2,name:"Feb",class:"width-34 divider-border-vertical-center"},{index:3,name:"Mar",class:"width-33 divider-border-vertical-left"},{index:4,name:"Apr",class:"width-33 divider-border-vertical-right"},{index:5,name:"May",class:"width-34 divider-border-vertical-center"},{index:6,name:"June",class:"width-33 divider-border-vertical-left"},{index:7,name:"July",class:"width-33 divider-border-vertical-right"},{index:8,name:"Aug",class:"width-34 divider-border-vertical-center"},{index:9,name:"Sept",class:"width-33 divider-border-vertical-left"},{index:10,name:"Oct",class:"width-33 divider-border-vertical-right"},{index:11,name:"Now",class:"width-34 divider-border-vertical-center"},{index:12,name:"Dec",class:"width-33 divider-border-vertical-left"}],t.initDefault=function(){t.rainPanel().find("input:radio[value='"+t._selected+"']").parent().button("toggle")},t.rainPanel=function(){return $("#rainMonthPanel")},t.calculate=function(e,i){return e<1?"grey":e<20?"red":e<70?"yellow":e<120?"green":e<200?"blue":(i.push(e),"white")},t.mapper=function(e){var i=[],n=e.map(function(e){return{target:e.target,months:e.months.map(function(e){return{number:e.number,alias:t.calculate(e.rainfall,i),name:e.name}})}});return console.log("MAX: "+i.sort()[i.length-1]),n},t.load=function(e){return t.initialLoad(e+t._file).then(function(e){t.data=t.mapper(e)})},t.setup=function(e){var i="gray",n=t.getDataItem(e,t.data);if(null!=n){var a=$.grep(n.months,function(e){return e.number===t._selected});i=a[0].alias}return i},t.setupMonth=function(e,i){var n="gray",a=t.getDataItem(e,t.data);if(null!=a){var r=$.grep(a.months,function(e){return e.number===i});n=r[0].alias}return n},t.evaluateCountry=function(e){e?($(t.months).filter(function(){this.alias=t.setupMonth(e,this.index);var i=this.alias;return this.icon=t.getCountryOption(e,t.options,function(){return i}),!0}),t.rainPanel().show(),t.activeCountry={}):($(t.months).filter(function(){return this.alias=null,this.icon=null,!0}),t.rainPanel().hide(),t.activeCountry=null)},t.evaluateGlobal=function(e){var i=$.grep(e,function(e){return e.name===t.name}).length>0;i?t.rainPanel().show():t.rainPanel().hide()}}angular.module("real.planet").service("rainService",["$q","baseFilterService",e])}();
!function(){function e(e,t){var a=angular.extend(this,t);a._file="safety/real.planet.safety.json",a.name="safety",a.icon={i:!0,class:"icon-safety-main",text:"Safety"},a.order=3,a.options=[{alias:"green",text:"Safest",checked:!1,icon:{i:!0,class:"icon-safety-green-filter",cellWidth:"33%"}},{alias:"yellow",text:"Should be careful",checked:!1,icon:{i:!0,class:"icon-safety-yellow-filter",cellWidth:"34%"}},{alias:"red",text:"Always look around",checked:!1,icon:{i:!0,class:"icon-safety-red-filter",cellWidth:"33%"}}],a.load=function(e){return a.initialLoad(e+a._file).then(function(e){a.data=e})},a.setupCountry=function(e){return a.setup(e)},a.setup=function(e){var t=a.getDataItem(e,a.data);return t?t.alias:"gray"},a.evaluateCountry=function(e){a.activeCountry=a.getCountryOption(e,a.options,a.setup)}}angular.module("real.planet").service("safetyService",["$q","baseFilterService",e])}();
!function(){function t(t,e){var i=angular.extend(this,e);i._file="tourist/real.planet.tourist.json",i.name="tourist",i.icon={i:!0,class:"icon-tourists-main",text:"Tourists"},i.order=4,i.options=[{alias:"blue",text:"You are white man",checked:!1,icon:{i:!0,class:"icon-tourists-green-filter",cellWidth:"25%"}},{alias:"green",text:"Messing around",checked:!1,icon:{i:!0,class:"icon-tourists-yellow-filter",cellWidth:"25%"}},{alias:"yellow",text:"Tourist grouping",checked:!1,icon:{i:!0,class:"icon-tourists-orange-filter",cellWidth:"25%"}},{alias:"red",text:"Tourist jam",checked:!1,icon:{i:!0,class:"icon-tourists-red-filter",cellWidth:"25%"}}],i.load=function(t){return i.initialLoad(t+i._file).then(function(t){i.data=t})},i.setupCountry=function(t){return i.setup(t)},i.setup=function(t){var e=i.getDataItem(t,i.data);return e?e.alias:"gray"},i.evaluateCountry=function(t){i.activeCountry=i.getCountryOption(t,i.options,i.setup)}}angular.module("real.planet").service("touristService",["$q","baseFilterService",t])}();
!function(){function e(e,n){var t=angular.extend(this,n);t._schengen=t._usa=!1,t._file="visa/{country}/round.world.visa.{country}.json",t.name="visa",t.order=1,t.icon={i:!0,class:"icon-visa-main",text:"Visa"},t.options=[{alias:"blue",text:"Home country",checked:!0,icon:{i:!0,class:"icon-home",cellWidth:"25%"}},{alias:"green",text:"Don't required",checked:!0,icon:{i:!0,class:"icon-visa-green-filter",cellWidth:"25%"}},{alias:"yellow",text:"On arrival or other",checked:!0,icon:{i:!0,class:"icon-visa-yellow-filter",cellWidth:"25%"}},{alias:"red",text:"Required",checked:!0,icon:{i:!0,class:"icon-visa-red-filter",cellWidth:"25%"}}],t.initUserSettings=function(e,n,a){t._schengen=e,t._usa=n,t._country=a},t.load=function(e){var n=t._file.replace("{country}",t._country).replace("{country}",t._country);return t.initialLoad(e+n).then(function(e){t.data=e})},t.setupCountry=function(e){return t.setup(e)},t.setup=function(e){var n=t.getDataItem(e,t.data),a="gray";return null!=n&&(t._schengen&&"green"===n.alias.schengen&&(a=n.alias.schengen),t._usa&&"green"===n.alias.usa&&(a=n.alias.usa),"green"!=a&&(a=n.alias.general)),a},t.addEvents=function(){$(document).on("change",'input:checkbox[value="schengen"],input:checkbox[value="usa"]',function(e){t._schengen=$('input:checkbox[value="schengen"]').is(":checked"),t._usa=$('input:checkbox[value="usa"]').is(":checked")})},t.evaluateCountry=function(e){if(t.activeCountry=t.getCountryOption(e,t.options,t.setup),e&&t.activeCountry.text){var n=t.getDataItem(e,t.data);n&&n.shortInfo&&(t.activeCountry.text=n.shortInfo)}}}angular.module("real.planet").service("visaService",["$q","baseFilterService",e])}();
!function(){function e(e,t){var i=angular.extend(this,t);i._selected=(new Date).getMonth()+1,i.name="weather",i._file="weather/real.planet.weather.json",i.icon={i:!0,class:"icon-weather-main",text:"Weather"},i.order=6,i.options=[{alias:"white",text:"Below zero",checked:!1,icon:{i:!0,class:"icon-weather-red-filter",cellWidth:"20%"}},{alias:"blue",text:"Quite cold",checked:!1,icon:{i:!0,class:"icon-weather-orange-filter",cellWidth:"20%"}},{alias:"green",text:"Just right",checked:!1,icon:{i:!0,class:"icon-weather-yellow-filter",cellWidth:"20%"}},{alias:"yellow",text:"Comfortable",checked:!1,icon:{i:!0,class:"icon-weather-green-filter",cellWidth:"20%"}},{alias:"red",text:"Hot potato",checked:!1,icon:{i:!0,class:"icon-fire",cellWidth:"20%"}}],i.months=[{index:1,name:"Jan",class:"width-33 divider-border-vertical-right"},{index:2,name:"Feb",class:"width-34 divider-border-vertical-center"},{index:3,name:"Mar",class:"width-33 divider-border-vertical-left"},{index:4,name:"Apr",class:"width-33 divider-border-vertical-right"},{index:5,name:"May",class:"width-34 divider-border-vertical-center"},{index:6,name:"June",class:"width-33 divider-border-vertical-left"},{index:7,name:"July",class:"width-33 divider-border-vertical-right"},{index:8,name:"Aug",class:"width-34 divider-border-vertical-center"},{index:9,name:"Sept",class:"width-33 divider-border-vertical-left"},{index:10,name:"Oct",class:"width-33 divider-border-vertical-right"},{index:11,name:"Now",class:"width-34 divider-border-vertical-center"},{index:12,name:"Dec",class:"width-33 divider-border-vertical-left"}],i.initDefault=function(){i.monthPanel().find("input:radio[value='"+i._selected+"']").parent().button("toggle")},i.monthPanel=function(){return $("#weatherMonthPanel")},i.load=function(e){return i.initialLoad(e+i._file).then(function(e){i.data=e})},i.setup=function(e){var t="gray",n=i.getDataItem(e,i.data);if(null!=n){var r=$.grep(n.months,function(e){return e.number===i._selected});t=r[0].alias}return t},i.setupMonth=function(e,t){var n="gray",r=i.getDataItem(e,i.data);if(null!=r){var a=$.grep(r.months,function(e){return e.number===t});n=a[0].alias}return n},i.evaluateCountry=function(e){e?($(i.months).filter(function(){this.alias=i.setupMonth(e,this.index);var t=this.alias;return this.icon=i.getCountryOption(e,i.options,function(){return t}),!0}),i.monthPanel().show(),i.activeCountry={}):($(i.months).filter(function(){return this.alias=null,this.icon=null,!0}),i.monthPanel().hide(),i.activeCountry=null)},i.evaluateGlobal=function(e){var t=$.grep(e,function(e){return e.name===i.name}).length>0;t?i.monthPanel().show():i.monthPanel().hide()}}angular.module("real.planet").service("weatherService",["$q","baseFilterService",e])}();