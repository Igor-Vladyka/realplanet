...
!function(){function t(t){var e=this;e._fileTemplate="{{name}}/real.planet.{{name}}.json",e.calculate=function(t){return JSON.parse(JSON.stringify(t))},e.mapper=function(t){var e=this;return t[0]?t.map(e.calculate):t},e.load=function(t){var e=this,n=e._fileTemplate.replace("{{name}}",e.name).replace("{{name}}",e.name);return e.initialLoad(t+n).then(function(t){e.data=t})},e.initialLoad=function(e){var n=this,a=t.defer();if("undefined"!==Storage&&localStorage[e]){var r=JSON.parse(localStorage[e]);a.resolve(n.mapper(r))}else $.getJSON(e,function(t){"undefined"!==Storage&&(localStorage[e]=JSON.stringify(t)),a.resolve(n.mapper(t))});return a.promise},e.getDataItem=function(t,e){var n=t.getId(),a=null,r=$.grep(e,function(t){return t.target===n});return r.length>0&&(a=r[0]),a},e.getCountryOption=function(t,e,n){var a=null;if(t){var r=n(t);a=$(e).filter(function(){return this.alias==r}),a=a&&a.length?a[0]:{text:" ",icon:{class:""},alias:r}}return a},e.setupCountry=function(t){return this.setup(t)},e.setup=function(t){var e=this.getDataItem(t,this.data);return e?e.alias:"gray"},e.evaluateCountry=function(t){this.activeCountry=this.getCountryOption(t,this.options,this.setup)}}angular.module("real.planet").service("baseFilterService",["$q",t])}();
!function(){function e(e,i){var t=angular.extend(this,i);t.name="budget",t.icon={i:!0,class:"icon-budget-main",text:"Budget"},t.order=2,t.options=[{alias:"blue",text:"Cheapest",checked:!1,icon:{i:!0,class:"icon-budget-green-filter",cellWidth:"25%"}},{alias:"green",text:"Really nice",checked:!1,icon:{i:!0,class:"icon-budget-yellow-filter",cellWidth:"25%"}},{alias:"yellow",text:"Can afford",checked:!1,icon:{i:!0,class:"icon-budget-orange-filter",cellWidth:"25%"}},{alias:"red",text:"Highest costs",checked:!1,icon:{i:!0,class:"icon-budget-red-filter",cellWidth:"25%"}}]}angular.module("real.planet").service("budgetService",["$q","baseFilterService",e])}();
...
!function(){function e(e,i){var t=angular.extend(this,i);t.name="tourist",t.icon={i:!0,class:"icon-tourists-main",text:"Tourists"},t.order=4,t.options=[{alias:"blue",text:"You are white man",checked:!1,icon:{i:!0,class:"icon-tourists-green-filter",cellWidth:"25%"}},{alias:"green",text:"Messing around",checked:!1,icon:{i:!0,class:"icon-tourists-yellow-filter",cellWidth:"25%"}},{alias:"yellow",text:"Tourist grouping",checked:!1,icon:{i:!0,class:"icon-tourists-orange-filter",cellWidth:"25%"}},{alias:"red",text:"Tourist jam",checked:!1,icon:{i:!0,class:"icon-tourists-red-filter",cellWidth:"25%"}}]}angular.module("real.planet").service("touristService",["$q","baseFilterService",e])}();
