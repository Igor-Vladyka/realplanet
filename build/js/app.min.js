function busyIndicator(e){}String.prototype.hash=function(){for(var e=this,r=Array(this.length),t=0;t<this.length;t++)r[t]=t;return Array.prototype.map.call(r,function(r){return e.charCodeAt(r).toString(16)}).join("")},toastr.options={closeButton:!1,debug:!1,newestOnTop:!1,progressBar:!1,positionClass:"toast-top-right",preventDuplicates:!0,onclick:null,showDuration:"300",hideDuration:"2000",timeOut:"3000",extendedTimeOut:"1000",showEasing:"swing",hideEasing:"linear",showMethod:"fadeIn",hideMethod:"fadeOut"},Array.prototype.removeAll=function(e){var r=this.indexOf(e);r!==-1&&(this.splice(r,1),this.removeAll(e))},L.Icon.Default.imagePath="images/markers/",navigator.serviceWorker&&navigator.serviceWorker.register("sw.js").then(function(e){$.get("images/markers/marker-icon-green.png"),$.get("images/markers/marker-icon-red.png"),$.get("images/markers/marker-icon-orange.png")}).catch(function(e){console.info("ServiceWorker registration failed: ",e)});
...
!function(){function e(e,t){var i=angular.extend(this,t);i._selected=(new Date).getMonth()+1,i.name="temperature",i._file="weather/real.planet.weather.json",i.icon={i:!0,class:"icon-weather-main",text:"Temperature"},i.order=6,i.options=[{alias:"white",text:"Below zero",checked:!1,icon:{i:!0,class:"icon-weather-red-filter",cellWidth:"20%"}},{alias:"blue",text:"Quite cold",checked:!1,icon:{i:!0,class:"icon-weather-orange-filter",cellWidth:"20%"}},{alias:"green",text:"Just right",checked:!1,icon:{i:!0,class:"icon-weather-yellow-filter",cellWidth:"20%"}},{alias:"yellow",text:"Comfortable",checked:!1,icon:{i:!0,class:"icon-weather-green-filter",cellWidth:"20%"}},{alias:"red",text:"Hot potato",checked:!1,icon:{i:!0,class:"icon-fire",cellWidth:"20%"}}],i.months=[{index:1,name:"Jan",class:"width-33 divider-border-vertical-right"},{index:2,name:"Feb",class:"width-34 divider-border-vertical-center"},{index:3,name:"Mar",class:"width-33 divider-border-vertical-left"},{index:4,name:"Apr",class:"width-33 divider-border-vertical-right"},{index:5,name:"May",class:"width-34 divider-border-vertical-center"},{index:6,name:"June",class:"width-33 divider-border-vertical-left"},{index:7,name:"July",class:"width-33 divider-border-vertical-right"},{index:8,name:"Aug",class:"width-34 divider-border-vertical-center"},{index:9,name:"Sept",class:"width-33 divider-border-vertical-left"},{index:10,name:"Oct",class:"width-33 divider-border-vertical-right"},{index:11,name:"Now",class:"width-34 divider-border-vertical-center"},{index:12,name:"Dec",class:"width-33 divider-border-vertical-left"}],i.initDefault=function(){i.monthPanel().find("input:radio[value='"+i._selected+"']").parent().button("toggle")},i.monthPanel=function(){return $("#"+i.name+"MonthPanel")},i.calculate=function(e){return e<=0?"white":e<10?"blue":e<19?"green":e<27?"yellow":"red"},i.mapper=function(e){var t=e.map(function(e){return{target:e.target,months:e.months.map(function(e){return{number:e.number,alias:i.calculate(e.index),title:Math.floor(e.index)+"°",index:e.index}})}});return t},i.setup=function(e){return i.setupMonth(e,i._selected)},i.setupMonth=function(e,t){var n="gray",r=i.getDataItem(e,i.data);if(null!=r){var a=$.grep(r.months,function(e){return e.number===t});a.length&&(n=a[0].alias)}return n},i.getIconTitle=function(e,t){var n=null,r=i.getDataItem(e,i.data);if(null!=r){var a=$.grep(r.months,function(e){return e.number===t});a.length&&(n=a[0].title)}return n},i.evaluateCountry=function(e){e?($(i.months).filter(function(){this.alias=i.setupMonth(e,this.index);var t=this.alias;return this.icon=i.getCountryOption(e,i.options,function(){return t}),this.title=this.icon.text+"("+i.getIconTitle(e,this.index)+")"||this.icon.text,!0}),i.monthPanel().show(),i.activeCountry={}):($(i.months).filter(function(){return this.alias=null,this.icon=null,this.title=null,!0}),i.monthPanel().hide(),i.activeCountry=null)},i.evaluateGlobal=function(e){var t=$.grep(e,function(e){return e.name===i.name}).length>0;t?i.monthPanel().show():i.monthPanel().hide()}}angular.module("real.planet").service("temperatureService",["$q","baseFilterService",e])}();
