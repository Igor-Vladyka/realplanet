...
!function(){function e(e,t,n,a,o,u,r,l,i){function s(e){switch(e){case"orange":e="#ca6531"}return e}function c(e){$(e.options).each(function(){this.checked=!1})}var d=this;d._content="//roundworlddata.bitbucket.org/",d.style={country_default:function(e){return d.moduleManager.country&&d.moduleManager.country.getId()==e.getId()?{weight:0,fillColor:s("orange"),color:s("orange"),opacity:1}:{weight:0,fillColor:"transparent",color:"transparent",opacity:0}}},d.initialize=function(t,s){d.moduleManager={modules:[]},d.boundsMap=t;var g=[],h=n.load(t,d._content,d.style.country_default,d.activateCountry);return g.push(h),c(a),d.moduleManager.modules.push(a),d.moduleManager[a.name]=a,g.push(a.load(d._content)),s.homeCountry?(o.initUserSettings(s.schengenVisa,s.usaVisa,s.homeCountry),d.moduleManager.modules.push(o),d.moduleManager[o.name]=o,g.push(o.load(d._content))):$(a.options).each(function(){this.checked=!0}),c(u),d.moduleManager.modules.push(u),d.moduleManager[u.name]=u,g.push(u.load(d._content)),c(r),d.moduleManager.modules.push(r),d.moduleManager[r.name]=r,g.push(r.load(d._content)),c(l),d.moduleManager.modules.push(l),d.moduleManager[l.name]=l,g.push(l.load(d._content)),c(i),d.moduleManager.modules.push(i),d.moduleManager[i.name]=i,g.push(i.load(d._content)),e.all(g)},d.initDefaults=function(e){setTimeout(function(){$("input:checked").parent("label:not(.active)").button("toggle"),i.monthPanel().find("input:radio[value='"+i._selected+"']").parent().button("toggle"),e&&i.monthPanel().show()},100)},d.evaluateMap=function(){d.activeFilters=[],$(d.moduleManager.modules).each(function(){var e=this;if(e.options){var t={name:e.name,aliases:[],origin:e},n=$(e.options).filter(function(){return this.checked&&t.aliases.push(this.alias),this.checked});n.length&&d.activeFilters.push(t)}}),d.activeFilters.length?1==d.activeFilters.length?n.layer.setStyle(d.setupSinglefilter):n.layer.setStyle(d.setupMultifilter):n.layer.setStyle(d.style.country_default),$(d.moduleManager.modules).each(function(){var e=this;e.evaluateGlobal&&e.evaluateGlobal(d.activeFilters)})},d.setupSinglefilter=function(e){var t="gray",n=d.activeFilters[0],a=n.origin.setup(e);return $.inArray(a,n.aliases)!=-1&&(t=a),{weight:0,fillColor:s(t),color:s(t),opacity:1}},d.setupMultifilter=function(e){var t="gray",n=!0;return $(d.activeFilters).each(function(){var t=this,a=t.origin.setup(e);return n=$.inArray(a,t.aliases)!=-1}),n&&(t="green"),{weight:0,fillColor:s(t),color:s(t),opacity:.8}},d.monthChanged=function(){d.moduleManager.country?d.evaluateModules(d.moduleManager.country):d.evaluateMap()},d.deactivateCountry=function(){d.moduleManager.country=null,d.evaluateMap(),d.evaluateModules(),t.transitionTo("filter",null,{location:!0,notify:!1})},d.activateCountryByIso=function(e){var t=n.getCountryByIso(e),a=new L.LatLngBounds(new L.LatLng(t.c.properties.min[1],t.c.properties.min[0]),new L.LatLng(t.c.properties.max[1],t.c.properties.max[0]));d.activateCountry(t.c,t.l,a)},d.activateCountry=function(e,n,a){d.moduleManager.country&&d.moduleManager.country.getId()==e.getId()?(d.deactivateCountry(),d.boundsMap.setView(L.latLng(0,0),3)):(d.moduleManager.country=e,d.evaluateModules(e),n.setStyle(d.style.country_default),t.transitionTo("filter",{iso3:e.properties.ISO3},{location:!0,notify:!1}),d.boundsMap.fitBounds(a))},d.evaluateModules=function(e){$(d.moduleManager.modules).each(function(){var t=this;t.evaluateCountry&&t.evaluateCountry(e)})},d.canChangeFilters=function(){return null==d.moduleManager.country}}angular.module("real.planet").service("filterModules",["$q","$state","countriesService","budgetService","visaService","touristService","safetyService","internetService","weatherService",e])}();
