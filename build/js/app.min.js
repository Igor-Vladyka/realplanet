window.notifyUpdateAvailable=function(){var e={closeButton:!1,debug:!1,newestOnTop:!1,progressBar:!1,positionClass:"toast-bottom-full-width",preventDuplicates:!0,onclick:function(){window.location.reload()},showDuration:"0",hideDuration:"0",timeOut:"0",extendedTimeOut:"0"};toastr.success("Reload to update.","New version available",e)},"serviceWorker"in navigator&&navigator.serviceWorker.register("sw.js").then(function(e){e.onupdatefound=function(){var t=e.installing;t.onstatechange=function(){switch(t.state){case"installed":navigator.serviceWorker.controller&&(console.info("New version available"),window.notifyUpdateAvailable());break;case"redundant":console.error("The installing service worker became redundant.")}}},$.get("images/markers/marker-icon-green.png"),$.get("images/markers/marker-icon-red.png"),$.get("images/markers/marker-icon-orange.png")}).catch(function(e){console.info("ServiceWorker registration failed: ",e)}),String.prototype.hash=function(){for(var e=this,t=Array(this.length),o=0;o<this.length;o++)t[o]=o;return Array.prototype.map.call(t,function(t){return e.charCodeAt(t).toString(16)}).join("")},toastr.options={closeButton:!1,debug:!1,newestOnTop:!1,progressBar:!1,positionClass:"toast-top-right",preventDuplicates:!0,onclick:null,showDuration:"300",hideDuration:"2000",timeOut:"3000",extendedTimeOut:"1000",showEasing:"swing",hideEasing:"linear",showMethod:"fadeIn",hideMethod:"fadeOut"},Array.prototype.removeAll=function(e){var t=this.indexOf(e);-1!==t&&(this.splice(t,1),this.removeAll(e))},L.Icon.Default.imagePath="images/markers/";
angular.module("real.planet",["ui.router","leaflet-directive"]).config(["$stateProvider","$httpProvider","$urlRouterProvider","$logProvider",function(t,e,r,i){r.otherwise("/filter/"),i.debugEnabled(!1),t.state("filter",{url:"/filter/:iso3",data:{isPublic:!0},templateUrl:"views/real.planet/real.planet.html"}).state("scraping",{url:"/scraping",data:{isPublic:!1},templateUrl:"views/scraping/main.html"})}]).directive("footer",function(){return{templateUrl:"views/footer.html"}}).run(["$rootScope","$state","AuthService",function(t,e,r){t.$on("$stateChangeStart",function(i,a,n,l,o){var u=r.isAuthenticated();angular.isObject(a.data)&&!0===a.data.isPublic||u||(i.preventDefault(),r.getAuthObject().then(function(r){if(!0===r.isAuthenticated)return e.go(a,n),void(t.currentUser=r);t.previos=a.name,e.go("login")},function(){e.go("login")}))})}]);
!function(){function e(e,t,n,a,i,l){function o(t,n,i){a.initialize(t,n).then(function(){e.moduleManager=a.moduleManager}).then(function(){a.initDefaults(i),i?a.activateCountryByIso(i):a.evaluateMap()})}function c(t){e.collapseTimeout||(e.collapseTimeout=setTimeout(function(){var n=$("#"+t+"Content");$("#switch"+t).attr("checked")?n.collapse("show"):n.collapse("hide"),e.collapseTimeout=null},0))}e.validateInitialWidth=function(){return window.innerWidth<768},n.initialize(e,{canAddMarkers:!1,placemarkControl:!1,searchControl:!1,mapProvider:"Esri.OceanBasemap",mapOpt:{click:function(e){}}}),n.getMap().then(function(e){l.getAuthObject().then(function(n){o(e,n,t.iso3)})}),e.checkFilter=function(e){a.canChangeFilters()&&(e.checked=!e.checked,a.evaluateMap())},e.checkModule=function(e){if(a.canChangeFilters()){var t=$(e.options).filter(function(){return this.checked});$(e.options).filter(function(){this.checked=0==t.length;var n=$("#"+e.name+" input[value='"+this.alias+"']");return this.checked?n.parent().is(".active")||n.parent().button("toggle"):n.parent().is(".active")&&n.parent().button("toggle"),!1}),a.evaluateMap(),c(e.name)}},e.selectMount=function(t){a.canChangeFilters()&&(e.moduleManager.temperature._selected=t,e.moduleManager.temperature.initDefault(),e.moduleManager.rain._selected=t,e.moduleManager.rain.initDefault(),a.monthChanged())},e.highlightHeader=function(e){return a.canChangeFilters()&&$(e.options).filter(function(){return this.checked}).length}}angular.module("real.planet").controller("filterController",["$scope","$stateParams","map","filterModules","leafletData","AuthService",e])}();
...
!function(){function e(e,t){var i=angular.extend(this,t);i._selected=(new Date).getMonth()+1,i.name="rain",i._file="weather/real.planet.weather.json",i.icon={i:!0,class:"icon-weather-main",text:"Rains"},i.order=7,i.options=[{alias:"red",text:"No rain at all",checked:!1,icon:{i:!0,class:"icon-fire",cellWidth:"20%"}},{alias:"yellow",text:"True rare",checked:!1,icon:{i:!0,class:"icon-weather-green-filter",cellWidth:"20%"}},{alias:"green",text:"Sometimes",checked:!1,icon:{i:!0,class:"icon-weather-yellow-filter",cellWidth:"20%"}},{alias:"blue",text:"Happens",checked:!1,icon:{i:!0,class:"icon-weather-orange-filter",cellWidth:"20%"}},{alias:"indigo",text:"Alwais rainy",checked:!1,icon:{i:!0,class:"icon-weather-red-filter",cellWidth:"20%"}}],i.months=[{index:1,name:"Jan",class:"width-33 divider-border-vertical-right"},{index:2,name:"Feb",class:"width-34 divider-border-vertical-center"},{index:3,name:"Mar",class:"width-33 divider-border-vertical-left"},{index:4,name:"Apr",class:"width-33 divider-border-vertical-right"},{index:5,name:"May",class:"width-34 divider-border-vertical-center"},{index:6,name:"June",class:"width-33 divider-border-vertical-left"},{index:7,name:"July",class:"width-33 divider-border-vertical-right"},{index:8,name:"Aug",class:"width-34 divider-border-vertical-center"},{index:9,name:"Sept",class:"width-33 divider-border-vertical-left"},{index:10,name:"Oct",class:"width-33 divider-border-vertical-right"},{index:11,name:"Now",class:"width-34 divider-border-vertical-center"},{index:12,name:"Dec",class:"width-33 divider-border-vertical-left"}],i.initDefault=function(){i.rainPanel().find("input:radio[value='"+i._selected+"']").parent().button("toggle")},i.rainPanel=function(){return $("#"+i.name+"MonthPanel")},i.calculate=function(e){return e?e<30?"red":e<80?"yellow":e<120?"green":e<200?"blue":"indigo":"gray"},i.mapper=function(e){return e.map(function(e){return{target:e.target,months:e.months.map(function(e){return{number:e.number,alias:i.calculate(e.index),title:Math.floor(e.index)+"mm",index:e.index}})}})},i.setup=function(e){return i.setupMonth(e,i._selected)},i.setupMonth=function(e,t){var n="gray",r=i.getDataItem(e,i.data);if(null!=r){var a=$.grep(r.months,function(e){return e.number===t});a.length&&(n=a[0].alias)}return n},i.getIconTitle=function(e,t){var n=null,r=i.getDataItem(e,i.data);if(null!=r){var a=$.grep(r.months,function(e){return e.number===t});a.length&&(n=a[0].title)}return n},i.evaluateCountry=function(e){e?($(i.months).filter(function(){this.alias=i.setupMonth(e,this.index);var t=this.alias;return this.icon=i.getCountryOption(e,i.options,function(){return t}),this.title=this.icon.text+"("+i.getIconTitle(e,this.index)+")"||this.icon.text,!0}),i.rainPanel().show(),i.activeCountry={}):($(i.months).filter(function(){return this.alias=null,this.icon=null,this.title=null,!0}),i.rainPanel().hide(),i.activeCountry=null)},i.evaluateGlobal=function(e){$.grep(e,function(e){return e.name===i.name}).length>0?i.rainPanel().show():i.rainPanel().hide()}}angular.module("real.planet").service("rainService",["$q","baseFilterService",e])}();
...
!function(){function e(e,t){var i=angular.extend(this,t);i._file="visa/real.planet.{country}.json",i.name="visa",i.order=1,i.icon={i:!0,class:"icon-visa-main",text:"Visa"},i.options=[{alias:"blue",text:"Home country",checked:!0,icon:{i:!0,class:"icon-home",cellWidth:"25%"}},{alias:"green",text:"Don't required",checked:!0,icon:{i:!0,class:"icon-visa-green-filter",cellWidth:"25%"}},{alias:"yellow",text:"On arrival or other",checked:!0,icon:{i:!0,class:"icon-visa-yellow-filter",cellWidth:"25%"}},{alias:"red",text:"Required",checked:!0,icon:{i:!0,class:"icon-visa-red-filter",cellWidth:"25%"}}],i.initUserSettings=function(e){i._country=e,i._fileTemplate=i._file.replace("{country}",e)},i.setupCountry=function(e){return i.setup(e)},i.setup=function(e){var t=i.getDataItem(e,i.data);return t?t.alias:"gray"},i.addEvents=function(){$(document).on("change",'input:checkbox[value="schengen"],input:checkbox[value="usa"]',function(e){i._schengen=$('input:checkbox[value="schengen"]').is(":checked"),i._usa=$('input:checkbox[value="usa"]').is(":checked")})},i.evaluateCountry=function(e){if(i.activeCountry=i.getCountryOption(e,i.options,i.setup),e&&i.activeCountry.text){var t=i.getDataItem(e,i.data);t&&t.shortInfo&&(i.activeCountry.text=t.shortInfo)}},i.calculate=function(e){return"HomeCountry"===e.index&&(e.alias="blue"),"NotRequired"===e.index&&(e.alias="green"),"OnArrival"===e.index&&(e.alias="yellow"),"Required"===e.index&&(e.alias="red"),e},i.canShowTimaticLink=function(e){return i._country.toLowerCase()!==e.toLowerCase()},i.showTimatic=function(e){var t=i.data.filter(function(t){return t.target==e});if(i.timaticWindow&&(i.timaticWindow.close(),i.timaticWindow=null),1==t.length){var n=screen.width/2-250,a=screen.height/2-350;i.timaticWindow=window.open("","Detailed Visa Information","location=0,menubar=0,status=0,titlebar=0,toolbar=0,width=500px,height=700px,left="+n+"px,top="+a+"px"),i.timaticWindow.document.write(i.constructChildWindow(t[0]))}},i.constructChildWindow=function(e){return"<style> h2{color: #222533} .trip{display:block;}</style>"+e.fullText+"<hr>"}}angular.module("real.planet").service("visaService",["$q","baseFilterService",e])}();
!function(){function e(e){var r=this;r._fileTemplate="places/real.planet.unesco.json",r.markerClusterFunction=function(e){return new L.DivIcon({html:"<div><span>"+e.getChildCount()+"</span></div>",className:"marker-cluster marker-cluster-"+this.style,iconSize:new L.Point(40,40)})},r.createMarker=function(e,n){var a=L.icon({iconUrl:L.Icon.Default.imagePath+"marker-icon-"+n+".png",iconSize:[25,41],iconAnchor:[12,41]});return L.marker([e.latitude,e.longitude],{icon:a,title:e.name_en}).bindPopup(r.createPopupContent(e),{keepInView:!0})},r.createPopupContent=function(e){var r='<h4 class="text-center">'+e.name_en+"</h4>";return e.image&&(r=r+'<img class="img-responsive hidden-xs" src="'+e.image+'"></img>'),r=r+"<div><i>"+e.short_description_en+"</i></div>"},r.createLayer=function(e){return L.markerClusterGroup({iconCreateFunction:r.markerClusterFunction,style:e,spiderfyOnMaxZoom:!1,showCoverageOnHover:!1,disableClusteringAtZoom:10})},r.mapper=function(e){var n=e.filter(function(e){return"Natural"==e.category}),a=e.filter(function(e){return"Cultural"==e.category}),t=e.filter(function(e){return"Mixed"==e.category}),i=r.createLayer("green");i.addLayers(n.map(function(e){return r.createMarker(e,"green")}));var o=r.createLayer("red");o.addLayers(a.map(function(e){return r.createMarker(e,"red")}));var c=r.createLayer("orange");return c.addLayers(t.map(function(e){return r.createMarker(e,"orange")})),{'<b class="name-cluster-green">Natural</b>':i,'<b class="name-cluster-orange">Mixed</b>':c,'<b class="name-cluster-red">Cultural</b>':o}},r.load=function(e,r){var n=this;return n.initialLoad(r+n._fileTemplate).then(function(r){L.control.layers(null,r).addTo(e)})},r.initialLoad=function(r){var n=this,a=e.defer();if("undefined"!==Storage&&localStorage[r]){var t=JSON.parse(localStorage[r]);a.resolve(n.mapper(t))}else $.getJSON(r,function(e){"undefined"!==Storage&&(localStorage[r]=JSON.stringify(e)),a.resolve(n.mapper(e))});return a.promise}}angular.module("real.planet").service("worldHeritageService",["$q",e])}();