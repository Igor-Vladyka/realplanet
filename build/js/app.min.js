...
!function(){function e(e,t){var n=angular.extend(this,t);n.name="internet",n.icon={i:!0,class:"icon-internet-main",text:"Internet"},n.order=5,n.options=[{alias:"blue",text:"Wifi everywhere",checked:!1,icon:{i:!0,class:"icon-internet-green-filter",cellWidth:"25%"}},{alias:"green",text:"Easy access",checked:!1,icon:{i:!0,class:"icon-internet-yellow-filter",cellWidth:"25%"}},{alias:"yellow",text:"Wifi can be found",checked:!1,icon:{i:!0,class:"icon-internet-orange-filter",cellWidth:"25%"}},{alias:"red",text:"OMG no internet...",checked:!1,icon:{i:!0,class:"icon-internet-red-filter",cellWidth:"25%"}}],n.setupCountry=function(e){return n.setup(e)},n.setup=function(e){var t=n.getDataItem(e,n.data);return t?t.alias:"gray"},n.evaluateCountry=function(e){n.activeCountry=n.getCountryOption(e,n.options,n.setup)},n.calculate=function(e){return e.index<15?e.alias="red":e.index<40?e.alias="yellow":e.index<75?e.alias="green":e.alias="blue",e}}angular.module("real.planet").service("internetService",["$q","baseFilterService",e])}();
!function(){function e(e,i){var n=angular.extend(this,i);n._selected=(new Date).getMonth()+1,n.name="rain",n._file="weather/real.planet.weather.json",n.icon={i:!0,class:"icon-weather-main",text:"Rains"},n.order=7,n.options=[{alias:"red",text:"No raint at all",checked:!1,icon:{i:!0,class:"icon-fire",cellWidth:"20%"}},{alias:"yellow",text:"True rare",checked:!1,icon:{i:!0,class:"icon-weather-green-filter",cellWidth:"20%"}},{alias:"green",text:"Sometimes",checked:!1,icon:{i:!0,class:"icon-weather-yellow-filter",cellWidth:"20%"}},{alias:"blue",text:"Happens",checked:!1,icon:{i:!0,class:"icon-weather-orange-filter",cellWidth:"20%"}},{alias:"white",text:"Alwais rainy",checked:!1,icon:{i:!0,class:"icon-weather-red-filter",cellWidth:"20%"}}],n.months=[{index:1,name:"Jan",class:"width-33 divider-border-vertical-right"},{index:2,name:"Feb",class:"width-34 divider-border-vertical-center"},{index:3,name:"Mar",class:"width-33 divider-border-vertical-left"},{index:4,name:"Apr",class:"width-33 divider-border-vertical-right"},{index:5,name:"May",class:"width-34 divider-border-vertical-center"},{index:6,name:"June",class:"width-33 divider-border-vertical-left"},{index:7,name:"July",class:"width-33 divider-border-vertical-right"},{index:8,name:"Aug",class:"width-34 divider-border-vertical-center"},{index:9,name:"Sept",class:"width-33 divider-border-vertical-left"},{index:10,name:"Oct",class:"width-33 divider-border-vertical-right"},{index:11,name:"Now",class:"width-34 divider-border-vertical-center"},{index:12,name:"Dec",class:"width-33 divider-border-vertical-left"}],n.initDefault=function(){n.rainPanel().find("input:radio[value='"+n._selected+"']").parent().button("toggle")},n.rainPanel=function(){return $("#"+n.name+"MonthPanel")},n.calculate=function(e){return e<30?"red":e<80?"yellow":e<120?"green":e<200?"blue":"white"},n.mapper=function(e){var i=e.map(function(e){return{target:e.target,months:e.months.map(function(e){return{number:e.number,alias:n.calculate(e.rainfall),index:e.rainfall,name:e.name}})}});return i},n.load=function(e){return n.initialLoad(e+n._file).then(function(e){n.data=e})},n.setup=function(e){var i="gray",t=n.getDataItem(e,n.data);if(null!=t){var a=$.grep(t.months,function(e){return e.number===n._selected});i=a[0].alias}return i},n.setupMonth=function(e,i){var t="gray",a=n.getDataItem(e,n.data);if(null!=a){var r=$.grep(a.months,function(e){return e.number===i});t=r[0].alias}return t},n.evaluateCountry=function(e){e?($(n.months).filter(function(){this.alias=n.setupMonth(e,this.index);var i=this.alias;return this.icon=n.getCountryOption(e,n.options,function(){return i}),!0}),n.rainPanel().show(),n.activeCountry={}):($(n.months).filter(function(){return this.alias=null,this.icon=null,!0}),n.rainPanel().hide(),n.activeCountry=null)},n.evaluateGlobal=function(e){var i=$.grep(e,function(e){return e.name===n.name}).length>0;i?n.rainPanel().show():n.rainPanel().hide()}}angular.module("real.planet").service("rainService",["$q","baseFilterService",e])}();
!function(){function e(e,t){var a=angular.extend(this,t);a.name="safety",a.icon={i:!0,class:"icon-safety-main",text:"Safety"},a.order=3,a.options=[{alias:"green",text:"Safest",checked:!1,icon:{i:!0,class:"icon-safety-green-filter",cellWidth:"33%"}},{alias:"yellow",text:"Should be careful",checked:!1,icon:{i:!0,class:"icon-safety-yellow-filter",cellWidth:"34%"}},{alias:"red",text:"Always look around",checked:!1,icon:{i:!0,class:"icon-safety-red-filter",cellWidth:"33%"}}],a.setupCountry=function(e){return a.setup(e)},a.setup=function(e){var t=a.getDataItem(e,a.data);return t?t.alias:"gray"},a.evaluateCountry=function(e){a.activeCountry=a.getCountryOption(e,a.options,a.setup)},a.calculate=function(e){return e.index<1.7?e.alias="green":e.index<2.4?e.alias="yellow":e.alias="red",e}}angular.module("real.planet").service("safetyService",["$q","baseFilterService",e])}();
!function(){function e(e,t){var n=angular.extend(this,t);n._selected=(new Date).getMonth()+1,n.name="temperature",n._file="weather/real.planet.weather.json",n.icon={i:!0,class:"icon-weather-main",text:"Temperature"},n.order=6,n.options=[{alias:"white",text:"Below zero",checked:!1,icon:{i:!0,class:"icon-weather-red-filter",cellWidth:"20%"}},{alias:"blue",text:"Quite cold",checked:!1,icon:{i:!0,class:"icon-weather-orange-filter",cellWidth:"20%"}},{alias:"green",text:"Just right",checked:!1,icon:{i:!0,class:"icon-weather-yellow-filter",cellWidth:"20%"}},{alias:"yellow",text:"Comfortable",checked:!1,icon:{i:!0,class:"icon-weather-green-filter",cellWidth:"20%"}},{alias:"red",text:"Hot potato",checked:!1,icon:{i:!0,class:"icon-fire",cellWidth:"20%"}}],n.months=[{index:1,name:"Jan",class:"width-33 divider-border-vertical-right"},{index:2,name:"Feb",class:"width-34 divider-border-vertical-center"},{index:3,name:"Mar",class:"width-33 divider-border-vertical-left"},{index:4,name:"Apr",class:"width-33 divider-border-vertical-right"},{index:5,name:"May",class:"width-34 divider-border-vertical-center"},{index:6,name:"June",class:"width-33 divider-border-vertical-left"},{index:7,name:"July",class:"width-33 divider-border-vertical-right"},{index:8,name:"Aug",class:"width-34 divider-border-vertical-center"},{index:9,name:"Sept",class:"width-33 divider-border-vertical-left"},{index:10,name:"Oct",class:"width-33 divider-border-vertical-right"},{index:11,name:"Now",class:"width-34 divider-border-vertical-center"},{index:12,name:"Dec",class:"width-33 divider-border-vertical-left"}],n.initDefault=function(){n.monthPanel().find("input:radio[value='"+n._selected+"']").parent().button("toggle")},n.monthPanel=function(){return $("#"+n.name+"MonthPanel")},n.load=function(e){return n.initialLoad(e+n._file).then(function(e){n.data=e})},n.calculate=function(e){return e<=0?"white":e<10?"blue":e<19?"yellow":e<27?"green":"red"},n.mapper=function(e){var t=e.map(function(e){return{target:e.target,months:e.months.map(function(e){return{number:e.number,alias:n.calculate(e.temperature),index:e.temperature,name:e.name}})}});return t},n.setup=function(e){var t="gray",i=n.getDataItem(e,n.data);if(null!=i){var r=$.grep(i.months,function(e){return e.number===n._selected});t=r[0].alias}return t},n.setupMonth=function(e,t){var i="gray",r=n.getDataItem(e,n.data);if(null!=r){var a=$.grep(r.months,function(e){return e.number===t});i=a[0].alias}return i},n.evaluateCountry=function(e){e?($(n.months).filter(function(){this.alias=n.setupMonth(e,this.index);var t=this.alias;return this.icon=n.getCountryOption(e,n.options,function(){return t}),!0}),n.monthPanel().show(),n.activeCountry={}):($(n.months).filter(function(){return this.alias=null,this.icon=null,!0}),n.monthPanel().hide(),n.activeCountry=null)},n.evaluateGlobal=function(e){var t=$.grep(e,function(e){return e.name===n.name}).length>0;t?n.monthPanel().show():n.monthPanel().hide()}}angular.module("real.planet").service("temperatureService",["$q","baseFilterService",e])}();
!function(){function e(e,t){var i=angular.extend(this,t);i.name="tourist",i.icon={i:!0,class:"icon-tourists-main",text:"Tourists"},i.order=4,i.options=[{alias:"blue",text:"You are white man",checked:!1,icon:{i:!0,class:"icon-tourists-green-filter",cellWidth:"25%"}},{alias:"green",text:"Messing around",checked:!1,icon:{i:!0,class:"icon-tourists-yellow-filter",cellWidth:"25%"}},{alias:"yellow",text:"Tourist grouping",checked:!1,icon:{i:!0,class:"icon-tourists-orange-filter",cellWidth:"25%"}},{alias:"red",text:"Tourist jam",checked:!1,icon:{i:!0,class:"icon-tourists-red-filter",cellWidth:"25%"}}],i.setupCountry=function(e){return i.setup(e)},i.setup=function(e){var t=i.getDataItem(e,i.data);return t?t.alias:"gray"},i.evaluateCountry=function(e){i.activeCountry=i.getCountryOption(e,i.options,i.setup)},i.calculate=function(e){return e.index<.2?e.alias="blue":e.index<.6?e.alias="green":e.index<.8?e.alias="yellow":e.alias="red",e}}angular.module("real.planet").service("touristService",["$q","baseFilterService",e])}();
