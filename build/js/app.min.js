...
!function(){function e(e,t){var i=angular.extend(this,t);i.name="budget",i.icon={i:!0,class:"icon-budget-main",text:"Budget"},i.order=2,i.options=[{alias:"blue",text:"Cheapest",checked:!1,icon:{i:!0,class:"icon-budget-green-filter",cellWidth:"25%"}},{alias:"green",text:"Really nice",checked:!1,icon:{i:!0,class:"icon-budget-yellow-filter",cellWidth:"25%"}},{alias:"yellow",text:"Can afford",checked:!1,icon:{i:!0,class:"icon-budget-orange-filter",cellWidth:"25%"}},{alias:"red",text:"Highest costs",checked:!1,icon:{i:!0,class:"icon-budget-red-filter",cellWidth:"25%"}}],i.setupCountry=function(e){return i.setup(e)},i.setup=function(e){var t=i.getDataItem(e,i.data);return t?t.alias:"gray"},i.evaluateCountry=function(e){i.activeCountry=i.getCountryOption(e,i.options,i.setup)}}angular.module("real.planet").service("budgetService",["$q","baseFilterService",e])}();
